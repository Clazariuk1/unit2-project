// Is there a way that we can prevent an instructor from taking on more than three courses and six dogs per course? Bonus round that one if able.

// Can we show course show page and instructor index on same page?
